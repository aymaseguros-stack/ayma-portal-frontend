    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {stats && (
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="text-2xl font-bold">{stats.total_contenidos}</div>
          </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            ...
            <div className="text-2xl font-bold">{stats.tasa_aprobacion}%</div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-4 border-b">
          <h3 className="text-xl font-semibold">⏳ Contenidos Pendientes de Aprobación ({contenidos.length})</h3>
        </div>
        <div className="p-4">
          {contenidos.length === 0 ? (
            <p className="text-gray-500 text-center py-8">No hay contenidos pendientes</p>
          ) : (
                ...
                <div key={contenido.token} className="border rounded-lg p-4 hover:bg-gray-50">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex-1">
                      <span className="font-mono text-xs text-gray-500">{contenido.token}</span>
                      <div className="mt-2 text-sm">
                        <strong>Canal:</strong> {contenido.channel}
                      </div>
